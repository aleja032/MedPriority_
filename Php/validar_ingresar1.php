...
$sql="SELECT * FROM usuario INNER JOIN historia_clinica ON historia_clinica.id_usuario= usuario.id_usuario INNER JOIN patologias ON patologias.id_patologia= historia_clinica.id_patologia INNER JOIN estado ON estado.id_estado=historia_clinica.id_estado WHERE correo='$correo' AND id_rol=2 AND contrasena='$password'";
$consulta= mysqli_query($conn,$sql);

$validacion_doc="SELECT * FROM usuario WHERE id_rol=3 AND contrasena='$password' AND correo='$correo'";
