        ...
        <div class="congeneral"><!--contendor 2 general para el menu y los formularios -->
            ...
            <main>
                    ...
                    <div id="panel_med" class="contain_main">
                        <div class="cont_titulo">
                            <p>Panel medicos</p>
                            <form class="search-container" id="form_search_doctor">
                                <input type="text" name="buscar_doctor" id="doctor_search">
                    ...
                    <div id="panel_pac" class="contain_main">
                        <div class="cont_titulo">
                            <p>Panel pacientes</p>
                            <form class="search-container" id="form_search_paciente">
                                <input type="text" name="buscar_paciente" id="doctor_search">
                                <button class="search-img"></button>
                            </form>
                        </div>
                            <div class="cont_general_all">
                    ...
                    <div id="panel_cita" class="contain_main">
                        <div class="cont_titulo">
                            ...
                            <form class="search-container" id="form_search_preagendamiento">
                                <input type="text" name="buscar_preagendamiento">
                                <button class="search-img"></button>
                            </form>
                        </div>
                        <div class="cont_general_all">
                    ...
                    <div id="panel_cita_agendada" class="contain_main">
                        <div class="cont_titulo">
                            ...
                            <form class="search-container" id="form_search_citas_agendadas">
                                <input type="text" name="buscar_citas_agendadas" >
                                <button class="search-img"></button>
                            </form>
                        </div>
                        <div class="cont_general_all">
                    ...
                    <div id="panel_pato" class="contain_main">
                        <div class="cont_titulo">
                            ...
                            <form class="search-container" id="form_search_patologia">
                                <input type="text" name="buscar_patologias" >
                                <button class="search-img"></button>
                            </form>
                        </div>
                        <div class="cont_general_all">
                    ...
                    <div id="panel_tcita" class="contain_main">
                        <div class="cont_titulo">
                            ...
                            <form class="search-container" id="form_search_tipo_cita">
                                <input type="text" name="buscar_tipo_cita" id="doctor_search">
                                <button class="search-img"></button>
                            </form>
                        </div>
                        <div class="cont_general_all">
                    ...
                    <div id="panel_especi" class="contain_main">
                        <div class="cont_titulo">
                            ...
                            <form class="search-container" id="form_search_especialidades">
                                <input type="text" name="buscar_especialidades" id="doctor_search">
                                <button class="search-img"></button>
                            </form>
                        </div>
                        <div class="cont_general_all">
...
<script src="../Js/Admin/buscador.js"></script>
</html>